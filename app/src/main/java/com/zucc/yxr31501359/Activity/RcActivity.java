...
import com.zucc.yxr31501359.calendar.CalendarView.OnItemClickListener;
...
public class RcActivity extends Activity {
        ...
        mListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int groupPosition, int childPosition, long l) {
                if(child.get(groupPosition).size() == childPosition + 1){
                    ...
                    Toast.makeText(RcActivity.this, "添加了一个日程" , Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(RcActivity.this, "hah" + childPosition , Toast.LENGTH_SHORT).show();
                }
                return false;
            }
        });
    ...
    private void init() {
        ...
        adapter = new ContactsInfoAdapter(group, child, RcActivity.this, getStrings(calendar.getYearAndmonthAndDate()), calendar.getNowWeek());
